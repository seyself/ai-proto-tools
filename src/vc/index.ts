...
//
    console.log(prompt);
    const response: any = await agent.send(prompt, { json: true });
 ...
 */
export function mergeBranch(fromBranch: string, toBranch: string = 'main'): void {
  try {
 ...
 */
export async function gitTest(): Promise<void> {
  // await commit();
